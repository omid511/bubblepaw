...
export default function Services() {
  return (
    <section id="services" className="scroll-mt-20 relative bg-[#F8FAFC] py-12 md:py-32 px-6 md:px-12 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl relative">
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-20 items-start">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            transition={{ duration: 0.5 }}
            className="lg:sticky lg:top-24 lg:pl-8"
          >
            ...
            <motion.h2
              ...
              className="font-[var(--font-display)] text-3xl md:text-5xl font-normal leading-[1.1] tracking-tight text-[#0F172A] mb-6"
            >
              Our Services
            </motion.h2>
